...
1. Clone this repository
   ...
   ```shell
   git clone https://github.com/namanctrvd/SAC-Election
   cd SAC-Election
   ```
...
- [ ] **Email Verification**—Registering voters directly through college mail ID.
- [ ] **Automated Password Verification**— Automatic genereted password sent to the verified college main address (rather than manually approving by the admin).
- [ ] **Election for multiple posts**—Ability to create elections for all the SAC post at the same time.
